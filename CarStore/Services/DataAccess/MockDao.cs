...
public class MockDao : IDao
{
    public List<Car> getAllCars()
    {
        var result = new List<Car>()
        {
            new(){
                ...
                Variant = new List<Variant> { new() { Name = "Trắng ngọc trai", Code = "White" }, new() { Name = "Xám khói", Code = "Grey" }, new() { Name="Đen huyền bí", Code="Black"} },
                Images = "Honda Accord",
            ...
            new(){
                ...
                Variant = new List<Variant> { new() { Name = "Đen huyền bí", Code = "Black" }, new() { Name = "Đỏ hoàng hôn", Code = "Red" }, new() { Name="Trắng tuyết", Code="White"} },
            ...
            new(){
                ...
                Variant = new List<Variant> { new() { Name = "Đen huyền bí", Code = "Black" }, new() { Name = "Đỏ hoàng hôn", Code = "Red" }, new() { Name="Trắng tuyết", Code="White"}, new() { Name="Xanh thẳm", Code="Blue"} },
                Images = "Honda Type R",
            ...
            new(){
                ...
                Variant = new List<Variant> {new() { Name = "Đỏ hoàng hôn", Code = "Red" },},
            ...
            new(){
                ...
                Variant = new List<Variant> { new() { Name = "Đại dương xanh", Code = "Blue" }, },
            ...
            new(){
                ...
                Variant = new List<Variant> {new() { Name = "Xanh đọt chuối", Code = "Green" },},
            ...
            new(){
                ...
                Variant = new List<Variant> {new() { Name = "Xanh hy vọng", Code = "Blue" },},
            ...
            new()
            {
                ...
                Variant = new List<Variant> {new() { Name = "Đen khói", Code = "Black" },},
    ...
    {
        return getAllCars().Take(8).ToList();
    }
